...
?>
  ...
  <body>
      ...
      <div class="row">
          ...
          <div class="col-md-9"> 
          <h1><i class="fa fa-pencil" aria-hidden="true"></i> Edit Users <small>Edit Users Details</small></h1><hr>
              <ol class="breadcrumb">
                  <li><a href="index.php"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a></li>
                  <li class="active"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Users</li>
              </ol>
              <?php
              ...
              if(isset($_POST['submit'])){
                  ...
                  else 
                  {
                      ...
                      if(mysqli_query($con,$update_query)){
                          ...
                          header("refresh:0; url=edit_users.php?edit=$edit_user");
                          if(!empty($image)){
